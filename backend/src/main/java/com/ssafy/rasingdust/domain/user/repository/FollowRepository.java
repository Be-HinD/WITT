...
public interface FollowRepository extends JpaRepository<Follow, Long> {
    ...
    @Query(value = "SELECT new com.ssafy.rasingdust.domain.user.dto.response.UserDto(u.id, u.userName, u.createDate, u.solvedCnt, u.bottle, u.growthPoint) FROM Follow f INNER JOIN User u ON f.following.id = u.id WHERE f.follower.id = :userId")
    ...
    @Query(value = "SELECT new com.ssafy.rasingdust.domain.user.dto.response.UserDto(u.id, u.userName, u.createDate, u.solvedCnt, u.bottle, u.growthPoint) FROM Follow f INNER JOIN User u ON f.follower.id = u.id WHERE f.following.id = :userId")
